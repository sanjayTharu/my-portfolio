...
def updatePost(request,slug):
    ...
    if request.method=='POST':
        ...
        return redirect('posts')
    context={'form':form}
    return render(request, 'base/post_from.html',context)
...
def loginPage(request):
    ...
    if request.method=='POST':
        ...
        try:
            ...
            messages.error(request,'User with this email doesnt exists')
