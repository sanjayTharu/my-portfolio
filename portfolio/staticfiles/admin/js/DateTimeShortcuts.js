...
(function(){
    ...
    var DateTimeShortcuts={
        ...
        addCalendar: function(inp){
            var num=DateTimeShortcuts.calendar.length;

            DateTimeShortcuts.calendarInputs[num]=inp;
            DateTimeShortcuts.dismissCalendarFunc[num]=function(){DateTimeShortcuts.dismissCalendar(num); return true};

            // shortcuts links (calendar item and "Today " link)
            var shortcurs_span=document.createElement('span');
            shortcurs_span.className=DateTimeShortcuts.shortCutsClass;
            inp.parentNode.insertBefore(shortcurs_span,inp.nextSibling);
            ...
            shortcurs_span.appendChild(document.createTextNode('\u00A0'));
            shortcurs_span.appendChild(today_link);
            shortcurs_span.appendChild(document.createTextNode('\u00A0|\u00A0'));
            shortcurs_span.appendChild(cal_link);

            // create a calendarbox div
            ...
            //      <a href-"#">Yesterday</a> | <a href="#">Today</a> |
            // </div>
            ...
            DateTimeShortcuts.calendar[num]=new Calendar(DateTimeShortcuts.calendarDivName2+num,DateTimeShortcuts.handleCalendarCallback(num));
            DateTimeShortcuts.calendar[num].drawCurrent();
        ...
        openCalendar: function(num){
            ...
            if(inp.value){
                ...
                if (re.test(year.toString())&&month>=1 && month<=12){
                    DateTimeShortcuts.calendar[num].drawDate(month,year,selected);
                }
            }
            // recalculate the clockboz position
            // it is ltr or rtl layout?
            if(window.getComputedStyle(document.body).direction !== 'rtl'){
        ...
        drawPrev:function(num){
            DateTimeShortcuts.calendar[num].drawPreviousMonth();
        },
        drawNext:function(num){
            DateTimeShortcuts.calendar[num].drawNextMonth();
        },
        handleCalendarCallback:function(num){
            var format=get_format('DATE_INPUT_FORMATS')[0];
            // the format needs to escaped a little
